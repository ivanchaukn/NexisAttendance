...
public class MainActivity_Old extends ActionBarActivity implements ActionBar.TabListener{
	...
	private void userLevel(AlertDialog.Builder builder, List<String> userLevelList)
	{
        ...
        builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
            	...
            	Toast.makeText(MainActivity_Old.this, "Authorized Level Changed", Toast.LENGTH_LONG).show();
            }
        });
	}
	...
	{
		FragmentAttendance uploadFrag = (FragmentAttendance) mSectionsPagerAdapter.getItem(0);
        ...
        {            
            ...
            public void onClick(View v)
            {
            	...
            	Toast.makeText(MainActivity_Old.this, "Notification is sent to " + channels.size() + " groups", Toast.LENGTH_SHORT).show();
            }
       });
	}
